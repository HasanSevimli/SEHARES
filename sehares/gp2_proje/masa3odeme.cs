...
namespace gp2_proje
{
    ...
    public partial class masa3odeme : Form
    {
        ...
        private void masa3odeme_Load(object sender, EventArgs e)
        {
            masa_odeme_getir();
            toplam_fiyat_getir();
        }
        void masa_odeme_getir()
        {
            ...
            da = new SqlDataAdapter("UPDATE masa3 SET urun_fiyat = urun_fiyat * 1.05  SELECT masa3.urun_adi AS urun,masa3.urun_fiyat AS fiyat FROM masa3", baglanti);
        ...
        void toplam_fiyat_getir()
        {
            ...
            da = new SqlDataAdapter("SELECT SUM(masa3.urun_fiyat) AS toplamfiyat FROM masa3", baglanti);
            DataTable siparistablo = new DataTable();
            da.Fill(siparistablo);
        ...
        private void ode_Click(object sender, EventArgs e)
        {
            if (masaodeme.SelectedRows.Count > 0)
            {
                ...
                if (masaodeme.SelectedRows.Count > 0)
                {
                    ...
                    string deleteQuery = $"DELETE FROM masa3 WHERE urun_adi = '{urunAd}' AND urun_fiyat = '{fiyat}'";
